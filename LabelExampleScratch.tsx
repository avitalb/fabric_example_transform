...
class SwatchColorPickerBasicExample extends React.Component<any, IBasicSwatchColorPickerExampleState> {
...
ReactDOM.render(<SwatchColorPickerBasicExample/>,document.getElementById("content"));